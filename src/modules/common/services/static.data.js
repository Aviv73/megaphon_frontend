...
export const features = [
  {
    ...
    img: require('@/assets/images/features/keadsAndYoughth.png'),
    content:  [ 
  ...
  },
  {
    ...
    img: require('@/assets/images/features/readAndLeisure.png'),
    content: [
  ...
  {
    title: 'חכמים ביום',
    img: require('@/assets/images/features/daySmarters.png'),
    content: [
