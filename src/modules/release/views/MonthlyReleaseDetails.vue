  ...
  <section class="monthly-release-details flex column gap30 height-all">
    <section class="release-hero-view flex align-center justify-center gap10">
      <div class="hero flex column inner-container">
        <button class="arrow-btn" @click="shiftChild(1)" :src="require('@/assets/images/pageArrow.svg')">
          <img :src="require('@/assets/images/pageArrow.svg')" :alt="'>'" style="transform:rotate(180deg)">
        </button>
          ...
          <div class="hero-content flex column align-start gap20">
            ...
            <router-link :to="{ params: {id: viewdChild._id} }">
              <button class="flex align-center gap5">
                ...
                <img :src="require('@/assets/images/small-arrow-white.png')" alt="➜"/>
              </button>
            </router-link>
          </div>
        </div>
        ...
        <button class="arrow-btn" @click="shiftChild(-1)" :src="require('@/assets/images/pageArrow.svg')">
          <img :src="require('@/assets/images/pageArrow.svg')" :alt="'>'">
        </button>
      </div>
    </section>
...
<script>
import ItemList from '../../common/cmps/ItemSearchList/ItemList.vue'
import ItemSearchList from '../../common/cmps/ItemSearchList/ItemSearchList.vue'
...
.monthly-release-details {
  ...
  .release-hero-view {
    ...
    background: url('~@/assets/images/bookshelf_background.jpg') fixed;
    padding: 30px;
    .hero {
      position: relative;
      .arrow-btn {
