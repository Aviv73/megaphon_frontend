    ...
    <div class="main-content-section flex-1 flex space-between gap60">
      ...
      <div class="hero-content flex column align-start gap15">
        ...
        <div class="table-like">
          <div class="row"><p>{{$t('release.by')}}</p><p>{{release.author}}</p></div>
          <div class="row"><p>{{$t('release.paint')}}</p><p>{{release.painter}}</p></div>
          <div class="row"><p>{{$t('release.translator')}}</p><p>{{release.translator}}</p></div>
          <div class="row"><p>{{$t('release.pageCount')}}</p><p>{{release.pageCount}}</p></div>
          <div class="row"><p>{{$t('release.forAge')}}</p><p>{{release.forAgeMax || 99}} - {{release.forAgeMin || 0}}</p></div>
          <div class="row"><p>{{$t('release.monthPublish')}}</p><p>{{monthPublish}}</p></div>
          <div class="row"><p>{{$t('release.price')}}</p><p>{{release.price}}</p></div>
        </div>
      </div>
    </div>
