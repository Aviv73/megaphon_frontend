<template>
  <form @submit.prevent="emitFilter" class="release-filter width-all flex align-center space-between gap20">
    ...
    <div class="serach flex align-center">
      ...
      <button>
        <img class="filter-icon-img" :src="require('@/apps/agam/assets/images/search.svg')"/>
      </button>
    </div>
    <div class="sorters toggle-btns flex gap10">
      ...
      ><img class="filter-icon-img" :src="require('@/apps/agam/assets/images/filter.svg')"/></button>
      <button 
