const baseImgSrc = '@/apps/clientApps/agam/assets/images';
...
export const crewMembers = [
  {
    name: 'ליאור שרף',
    img: require(`@/apps/clientApps/agam/assets/images/crew/lior.png`),
    role: 'בעלים ומנכ"ל ההוצאה',
    contactFor: 'לאנשים שלא מצפים לקבל תשובה במילניום הקרוב'
  },
  {
    name: 'ראובת ניצן',
    img: require(`@/apps/clientApps/agam/assets/images/crew/reovat.png`),
    role: 'עורכת ההוצאה',
    contactFor: 'הגשת כתב יד, וקבלת מידע על הוצאת ספר באגם'
  },
  {
    name: 'נטע שרף שוכמן',
    img: require(`@/apps/clientApps/agam/assets/images/crew/neta.png`),
    role: 'מנהלת השיווק',
    contactFor: 'הצעות לשיתופי פעולה, הגשת קו"ח ופניות כלליות'
  },
  {
    name: 'טל שוכמן',
    img: require(`@/apps/clientApps/agam/assets/images/crew/tal.png`),
    role: 'מנהל דיגיטלי',
...
export const features = [
  {
    ...
    img: require(`@/apps/clientApps/agam/assets/images/features/keadsAndYoughth.png`),
    content:  [ 
  ...
  },
  {
    ...
    img: require(`@/apps/clientApps/agam/assets/images/features/readAndLeisure.png`),
    content: [
  ...
  {
    title: 'חכמים ביום',
    img: require(`@/apps/clientApps/agam/assets/images/features/daySmarters.png`),
    content: [
