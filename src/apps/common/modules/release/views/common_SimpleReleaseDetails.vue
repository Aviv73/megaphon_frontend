  ...
  <section v-if="release" class="simple-release-details inner-container main-pad-y flex align-start gap50">
    ...
    <div class="content-section flex column gap30">
      ...
      <div class="main-content-section flex-1 flex wrap space-between gap60">
        <img class="main-img" :src="imgToRender" :alt="release.title"/>
        <div id="content" class="hero-content flex column align-start gap15">
          <div class="description-container" v-if="release.content || release.desc" v-html="release.content || release.desc"></div>
...
export default {
  ...
  name: 'common_SimpleReleaseDetails',
  props: {
    release: {
      type: Object,
      required: true
  ...
  computed: {
    ...
    imgToRender() {
      return this.release.mainImage?.src || this.release.mainImage?.[0]?.src;
    },
